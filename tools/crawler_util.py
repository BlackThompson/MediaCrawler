...
async def find_login_qrcode(page: Page, selector: str, timeout: int = 60000) -> str:
...
async def find_qrcode_img_from_canvas(
    page: Page, canvas_selector: str, timeout: int = 60000
) -> str:
    """
